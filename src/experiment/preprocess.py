...
random.seed(42)
"""
training set, test set 랜덤 추출 구현해야 함.
"""
...
def preprocess_apnea_ecg_database():
    ...
    o_test, o_test_5, y_test, groups_test = preprocess_released_set()
    ...
    with open('../../output/preprocessed/apnea-ecg-physionet.pkl', 'wb') as f:
        pickle.dump(apnea_ecg, f, protocol=2)

    print('preprocess PhysioNet apnea-ecg-database-1.0.0 finish!')
    print('preprocessed file saved as \'output/preprocessed/apnea-ecg-physionet.pkl\' \n')
